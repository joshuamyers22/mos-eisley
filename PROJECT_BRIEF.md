...
- Success criteria: documented CLI works from the built wheel; missing quorum and
  malformed evidence and tool histories fail closed; identical recordings reproduce
  identical results;
  strict typing, tests, >=85% branch-inclusive coverage, packaging and CI are green.
- Non-goals for this phase: live model calls, machine tools, sandboxing, test
...
- Architecture choices: see `docs/adr/0001-offline-foundation.md` and
