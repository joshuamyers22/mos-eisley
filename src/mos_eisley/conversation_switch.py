...
def fresh_directory_arguments(
    ...
    values.update(
        ...
        task_profile_selection=None,
        task_profile_policy=None,
        task_tool_catalog=None,
        task_tool_selection=None,
        task_state_selection=None,
        task_state_continuation_selection=None,
        task_state_continuation_claim=None,
        task_approval_selection=None,
        session_id=None,
        last=False,
        inspect=False,
