"""Review explicit advisory conflicts without accepting policy or requirements."""
...
def run_command(args: argparse.Namespace) -> int:
    store = GuidanceConflictStore(args.guidance_storage)
    ...
    print(
        json.dumps(
            {"type": "guidance.conflicts", **receipt},
            ensure_ascii=True,
