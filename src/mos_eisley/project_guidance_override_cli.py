"""Review project override profiles and inspect effective advisory guidance."""
...
def run_command(args: argparse.Namespace) -> int:
    store = GuidanceOverrideStore(args.guidance_storage)
