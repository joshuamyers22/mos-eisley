...
evaluate the now-freezable candidate policy on protected holdout outcomes, or detect
provider drift. These controls remain required before a report can promote a routing
policy.
