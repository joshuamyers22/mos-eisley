...
Astra/max probes each count as one success. The first two completed attempts from the
second campaign add the second and third consecutive Luna/low successes. Current
progress is therefore 8 of 18: Luna/low is complete at 3 of 3 and the other five
profiles are each 1 of 3. The retained campaign receipts are documented in
...
known, as documented in [Milestone 60](MILESTONE_60_REVIEW.md), and its first two
authenticated results are documented in [Milestone 61](MILESTONE_61_REVIEW.md) and
