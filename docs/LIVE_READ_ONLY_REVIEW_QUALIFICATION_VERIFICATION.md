...
- Rubric result and blocking findings: Q-003 remains accepted by the accountable owner;
  ...
  Q-007 is corrected offline by native strict output and deterministic two-of-three
  resilience, but has no fresh live proof and grants no new run authority.
