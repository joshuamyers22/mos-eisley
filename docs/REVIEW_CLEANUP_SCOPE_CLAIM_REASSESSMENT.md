...
- Remaining uncertainty: the retained three live verdicts remain `reject`; this reassessment does not rewrite them or itself grant subject qualification. An accountable owner must decide whether this evidence is sufficient or whether a separate reviewer-legibility change and wholly fresh campaign are desired.
