...
- Revision lineage: `bac7dd24dc5a8a5e20b4b79a229dffc73882c88c` was the original implementation base; `0010970a8960161266841dc59a64c0ef58c48221` is the exact implementation commit and live-campaign revision. The post-campaign correction starts from clean descendant `c29e46bee58e8c109a5dc8b49c15f8534cee07fc`.
...
- Production-like replay/fault/rollback evidence: the exact `0010970a` image completed a three-slot campaign with campaign status `accepted`; content verdicts were `reject`, `revise`, `reject` and supplied W-002/W-003. No provider call was made for this correction.
- Remaining uncertainty, owners, and dates: the accepted campaign is evidence for the old exact commit/image, not launch authority for this corrected commit. Any later launch path needs a newly built image, fresh evidence and separately reviewed authorization; Joshua Myers.
