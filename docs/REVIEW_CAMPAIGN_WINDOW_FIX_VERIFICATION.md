...
- Maximum iterations: seven evidence-changing passes, including bounded corrections prompted by offline or retained campaign evidence.
...
- Remaining uncertainty, owners, and dates: the fresh corrected-image campaign is terminal and incomplete after slot 1 rejected; the verified hardening still requires a clean commit, rebuilt production image and wholly fresh campaign before any further live qualification; Joshua Myers.
