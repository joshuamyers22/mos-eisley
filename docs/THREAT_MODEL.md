...
| A passing skill report silently changes runtime behavior | Reports deny promotion; signed receipts, archive bindings, release control, and quarantine staging still literally deny installation, activation, and configuration mutation | Signed installation, atomic default changes, and drift gates are not implemented |
