...
| A passing skill report silently changes runtime behavior | Seal, claim, and report contracts literally deny activation; report also literally denies promotion | A separate authenticated promotion, rollback, expiry, and drift system is not implemented |
