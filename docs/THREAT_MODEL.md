...
| A passing skill report silently changes runtime behavior | Reports deny promotion; signed receipts, archive bindings, and release control still literally deny installation, activation, and configuration mutation | Transactional installation, atomic default changes, and drift gates are not implemented |
