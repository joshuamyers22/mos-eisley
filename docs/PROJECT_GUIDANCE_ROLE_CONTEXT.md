...
current. The next admission/loader slice must validate a safe run boundary, pin the
packet to run provenance and preserve independent runtime authorization. These
